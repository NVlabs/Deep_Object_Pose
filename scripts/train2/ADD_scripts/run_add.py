...
parser.add_argument('--models', 
    ...
    default = "/home/andrewg/Documents/dope_ws/YCB_models/test",
...
def get_models(path,suffix=""):
    ...
    for folder in glob.glob(path+"/*/"):
        ...
        models[model_name] = create_obj(
            ...
            path_obj = folder + "textured_simple.obj",
...
print("data_thruth[0]",data_thruth[0])
print("data_prediction[0]",data_prediction[0])
...
for gt_file in data_thruth:
    ...
    for obj_guess in gu_json['objects']:
        ...
        # print("name_look_up", name_look_up)
        # print("obj_guess['class']", obj_guess['class'])
        ...
        if best_index != -1:
            if not name_look_up in adds_objects.keys():
                 adds_objects[name_look_up] = []
            adds_all.append(best_dist)
            adds_objects[name_look_up].append(best_dist)
