...
python render_json.py --path_json data/table_dope_results/scene1/00300.json --opencv
# for scenes generated by nvisii 
python render_json.py --path_json data/table_ground_truth/scene1/00100.json
```
